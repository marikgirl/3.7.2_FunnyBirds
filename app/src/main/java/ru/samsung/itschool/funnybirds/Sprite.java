...
public class Sprite {
    ...
    public Sprite(double x,
        ...
        //отведенное время на отображение 1 кадра
        this.frameTime = 25;
        ...
        //внутрениий отступ от границ спрайта
        this.padding = 20;
    ...
    //обновление картинок, перебор кадров
    ...
    //прямоугольная область при столкновении
    ...
    //определение пересечения спрайтов
